...
public class Ex45{
    public static void main(String[] args) {
        ...
        System.out.printf("Quantidade de queijo necessária: %.2f quilos%n", totalQueijoQuilos);
        System.out.printf("Quantidade de presunto necessária: %.2f quilos%n", totalPresuntoQuilos);
        System.out.printf("Quantidade de carne (hambúrguer) necessária: %.2f quilos%n", totalHamburguerQuilos);
